...
latex_documents = [
    (master_doc, "ensembl_py.tex", "Ensembl Python Base Library Documentation", "Ensembl", "manual"),
]
...
man_pages = [(master_doc, "ensembl-py", "Ensembl Python Base Library Documentation", [author], 1)]
